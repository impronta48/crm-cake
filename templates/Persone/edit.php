...
<div class="row">
  <aside class="col col-md-3">
    <div class="side-nav">
      ...
      <?= $this->Form->postLink(
        __('Delete'),
        ['action' => 'delete', $persone->id],
        ['confirm' => __('Are you sure you want to delete # {0}?', $persone->id), 'class' => 'nav-link']
      ) ?>
      <?= $this->Html->link(__('List Persone'), ['action' => 'index'], ['class' => 'nav-link']) ?>
    </div>
  </aside>
